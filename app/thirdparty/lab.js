// Downstream ==> http://github.com/partoa/LABjs/blob/06e090382ad0cc1ddf93cc74bf275f7d0ec209a6/LAB.src.js
...
(function(global){
    ...
    fGETELEMENTSBYTAGNAME = function(tn){
        return oDOC.getElementsByTagName(tn);
    },
    ...
    function engine(queueExec,opts) {
        ...
        function loadScriptCache(scriptentry,src,type,charset) {
            ...
            if (first_pass && scriptentry[sPRELOADDONE] == nNULL) { // need to preload into cache
                ...
                scriptentry[sLOADTRIGGER] = function(){
                    loadScriptCache.apply(nNULL,args);
                };
            }
        ...
        function loadScriptXHR(scriptentry,src,type,charset) {
            ...
            if (first_pass && scriptentry[sPRELOADDONE] == nNULL) { // need to preload
                ...
                xhr[sONREADYSTATECHANGE] = function(){
                ...
                scriptentry[sLOADTRIGGER] = function(){
                    loadScriptXHR.apply(nNULL,args);
                };
            }
        ...
        publicAPI = {
            script:function() {
                ...
                end_of_chain_check_interval = fSETTIMEOUT(function(){
                    first_pass = bFALSE;
                },5); // hack to "detect" the end of the chain if a wait() is not the last call
                return use_engine;
            },
            wait:function(func) {
                fCLEARTIMEOUT(end_of_chain_check_interval);
    ...
    function processOpts(opts) {
        var k, newOpts = {}, 
        boolOpts = {
            "UseCachePreload":"cache",
            "UseLocalXHR":"xhr",
            "UsePreloading":sPRELOAD,
            "AlwaysPreserveOrder":sPRESERVE,
